    ...
    <header className="hero">
      <div className="hero-content">
        ...
        <div className="social-links reveal-up" style={{animationDelay: '0.2s', justifyContent: 'flex-start'}}>
          <a href="https://linkedin.com/in/ryyan-safar-038a82288/" target="_blank" aria-label="LinkedIn"
            data-magnetic>LinkedIn</a>
          <span className="separator">/</span>
          <a href="https://github.com/ryyansafar" target="_blank" aria-label="GitHub" data-magnetic>GitHub</a>
          <span className="separator">/</span>
      ...
      <section id="projects" className="section-padding">
        <div className="container">
          ...
          <div className="more-projects reveal-up">
            <a href="https://github.com/ryyansafar" target="_blank" className="btn btn-outline">View All Projects on
              GitHub</a>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="contact-wrapper reveal-up">
            ...
            <div className="footer-socials">
              <a href="https://github.com/ryyansafar" target="_blank" className="social-link" aria-label="GitHub"
                data-magnetic>
              ...
              <a href="https://linkedin.com/in/ryyansafar" target="_blank" className="social-link" aria-label="LinkedIn"
                data-magnetic>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path
              ...
              <a href="https://tinkerhub.org/@ryyansafar" target="_blank" className="social-link" aria-label="TinkerHub"
