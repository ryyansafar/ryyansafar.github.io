...
export const metadata: Metadata = {
  ...
  description: 'Desktop & phone wallpapers by Ryyan Safar. Coming soon.',
};
  ...
  return (
    <div style={{
      ...
      <p style={{ fontSize: '0.75rem', color: 'rgba(27,28,25,0.45)', letterSpacing: '0.05em', margin: 0, textAlign: 'center', maxWidth: 320 }}>
        Desktop &amp; phone wallpapers. Download, use, share.
      </p>

      <Link href="/design" className="wp-back" style={{
        fontFamily: "'Space Grotesk', sans-serif",
